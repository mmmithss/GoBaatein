...
import { BellIcon, CodeIcon, HomeIcon, UsersRoundIcon } from "lucide-react";
...
const SideBar = () => {
  ...
  return (
    <aside className=" hidden w-64 bg-base-200 border-base-300 md:flex lg:flex flex-col h-screen sticky top-1">
